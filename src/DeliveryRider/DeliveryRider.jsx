...
function DeliveryRider() {
  ...
  const route = [
    ...
    [
      selectedDelivery.destination.latitude,
      selectedDelivery.destination.longitude,
    ],
  ];
  ...
  return (
    <main className="rider-page">
      ...
      <section className="rider-content" id="overview">
        ...
        >
          ...
          <article className="rider-stat-card">
            ...
            <div>
              ...
              <strong>₱840</strong>
              <small>₱140 bonus included</small>
            </div>
          </article>
        </section>
        ...
        <section className="rider-dashboard-grid">
          <article className="rider-card route-card">
            ...
            <div className="route-summary">
              <div className="route-point">
                ...
                <div>
                  <small>Pickup</small>
                  <strong>BloomBox dispatch hub</strong>
                </div>
              </div>
              ...
              <div className="route-point">
                ...
                <div>
                  <small>
                    Next stop · {selectedDelivery.eta}
                  </small>
          ...
          <article className="rider-card active-delivery-card">
            ...
            <div className="delivery-notes">
              ...
              <p>
                Leave the flowers with the recipient. Please call
                if you need help finding the entrance.
              </p>
            </div>
        ...
        <section
          className="rider-card deliveries-card"
          id="deliveries"
        >
          ...
          {activeTab === "today" ? (
            ...
            <div className="empty-deliveries">
              <strong>Great work today!</strong>
              <span>
                You&apos;ve completed 8 deliveries. Keep it up.
              </span>
            </div>
          )}
        </section>
