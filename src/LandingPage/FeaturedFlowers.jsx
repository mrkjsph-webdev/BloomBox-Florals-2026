...
const flowers = [
  {
    ...
    name: "Rose",
    description:
      "A timeless flower perfect for expressing love and appreciation.",
  ...
  },
  {
    ...
    name: "Tulip",
    description:
      "A cheerful and elegant bloom that brings warmth to every bouquet.",
    category: "Birthdays",
    image:
  ...
  },
  {
    ...
    name: "Sunflower",
    description:
      "A bright and joyful flower that adds energy to every celebration.",
  ...
  },
  {
    ...
    name: "Lily",
    description:
      "A graceful bloom that brings a sophisticated touch to any arrangement.",
    category: "Wedding",
    image:
  ...
  },
  {
    ...
    name: "Daisy",
    description:
      "A simple and charming flower that brings a feeling of happiness.",
    category: "Birthdays",
    image:
  ...
  },
  {
    ...
    name: "Orchid",
    description:
      "An elegant flower that creates a refined and memorable bouquet.",
    category: "Wedding",
    image:
  ...
  },
  {
    ...
    name: "Carnation",
    description:
      "A beautiful long-lasting flower suited for meaningful occasions.",
    category: "Graduation",
    image:
  ...
  },
  {
    ...
    name: "Peony",
    description:
      "A soft and romantic bloom that makes every bouquet feel special.",
    category: "Anniversary",
    image:
  ...
  return (
    <section className="featured-flowers" id="flowers">
        ...
        {filteredFlowers.map((flower) => (
          <div className="flower-card" key={flower.id}>
            ...
            <div className="flower-card-body">
              ...
              <button onClick={() => navigate(`/flower-details/${flower.id}`)}>
                View Flower
              </button>
            </div>
          </div>
      ...
      {filteredFlowers.length === 0 && (
        <p className="no-results">No flowers found.</p>
      )}
    </section>
  );
}
